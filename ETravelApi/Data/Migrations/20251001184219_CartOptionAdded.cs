...
{
    /// <inheritdoc />
    public partial class CartOptionAdded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItem_CustomerData_CustomerDataId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    PerUnitPrice = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItem_CustomerDataId",
                table: "CartItem",
